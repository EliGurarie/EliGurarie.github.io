...
author: "Elie Gurarie" 
subtitle: "Values / Expectations / Practical Matters" 
...
$${\cal W} = \rho_1 {\cal N} + \rho_2 {\cal X} + \rho_3 {\cal M} + \rho_4 {\cal A} + \rho_5 {\cal P} + ...$$
...
We are **rigorous** - we avoid short-cuts and do the best possible work, and we are **creative** - looking for out-of-the box solutions.  But wa are also **humble**; especially with respect to tremendous complexity and ultimate unknowability of our study subjects, and with respect to the knowledge that others hold about study systems and research tools (see *collaboration* above). 

We value **diversity** enormously: intersecting difference—of background, perspective, discipline, and approach only ever strengthens science. But to unleash the promsises of that intersectionality, we actively work to build an inclusive environment.

We **communicate** directly and frequently - with collaborators, within our lab, and with me. Any material concerns, practical concerns, but also, please be aware of your mental well-being and capacity.   
...
### Your Commitments as Grad Students
...
- As a grad student - throughout the year - you are technically approximately 50% *student* pursuing your degree, and 50% either *scholar* (funded Research Assistant) or *educator* (Graduate Teaching Assistant GTA).  Your priority should generally be your thesis research. If you are supported as a teaching assistant or on a research assistanceship that is not directly related to your thesis work, be sure to give the research work the space and time it needs to progress regularly.  

- Attend (& collectively coordinate) weekly **lab meetings** (see below)

- Engage with the lab’s intellectual life: give talks, ask questions, attend seminars, share papers. 

- In collaboration with me, Pursue funding where appropriate: scholarships, fellowships, travel grants—and help others do the same.  Eligible students should, for example, be applying for NSF Graduate Research Fellowships annually.  And there are multiple more localized ESF-specific grant opportunities to pursue. 
...
- **The big lab computer** in Illick 244 runs Ubuntu and is available to all lab members for computational work. 
...
## 7. Data, Mentoring, and Milestones

- We take **data responsibility** seriously. Back it up. Label it clearly. Don’t share it without permission.
- You will develop a **mentoring and goals document** early in your program. We’ll revisit this periodically to reflect, adjust timelines, and stay aligned.
- You’ll be expected to have **one committee meeting per year** and complete a graduate student self-evaluation. These help keep you and your committee on the same page.

---

## 8. Time Off, Boundaries, and Support
...
- SUNY-ESF has resources for mental health and counseling. 
