...
subtitle: "Values, Commitments, and Practicalities" 
author: "Elie Gurarie" 
...
- Read and be aware of the [ESF Environmental Biology graduate student handbook](https://www.esf.edu/biology/graduate/documents/eb-graduate-handbook-2026.pdf).  Although I am here to help at every step, it is ultimatly the student's responsibility to make sure that all the bureaucratic boxes are being checked (there are *a lot* of forms & deadlines & hoops).
...
There is an important section in the [EB Graduate Handbook](https://www.esf.edu/biology/graduate/documents/eb-graduate-handbook-2026.pdf) on the the recommended course of action should a conflict arise between a graduate student and major professor.  Principles of professionalism, respect, collegiality and open lines of communication generally immunize from conflicts, but the flowchart below effectively summarizes the best route for working through conflicts that can't be resolved in person.  In essence the graduate director (Dr. Cohen), other committee members, and the department chair are all there resolve issues that arise:

![](conflict_flowchart.png)
